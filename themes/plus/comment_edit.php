...
<?php } else{?>
<script src="<?php echo base_url('/themes/meiri/js/jquery.upload.js')?>" type="text/javascript"></script>
<script src="<?php echo base_url('/themes/meiri/js/qiniu.js')?>" type="text/javascript"></script>
<?php }?>
</head>
<body id="startbbs">
...
<span class="text-muted" style="float:right;margin:7px 0;">( 可直接粘贴链接和图片地址 / 发代码用 &lt;pre&gt; 标签 )</span>
</div>
</div>
<div class="col-sm-9">
