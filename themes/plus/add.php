...
<title><?php echo $settings['site_name']?> / 创建新主题</title>
</head>
<body>
			...
			<div class="box">
				...
				<div class="cell">
					<form accept-charset="UTF-8" action="<?php echo site_url('forum/add')?>" id="new_topic" method="post" novalidate="novalidate" name="add_new">
						...
						<table cellpadding="5" cellspacing="0" border="0" width="100%">
							<tr>
								<td>
									<input class="mle" style="height: 60px; width: 640px;" id="topic_title" name="title" type="text" value="<?php echo set_value('title'); ?>" />
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td>
									<textarea class="mle" style="height: 200px; width: 640px;" id="topic_content" name="content" placeholder="话题内容" rows="10"><?php echo set_value('content'); ?>		
									</textarea>
							...
							<tr>
                				<td>
                					...
                					<input class="super normal button" data-disable-with="正在提交" name="commit" type="submit" value="创建" />
                				</td>
                			</tr>
                		</table>
                	</form>
                ...
                <div class="inner">
                	...
                	<ul>
                		...
                		<li>作品发布型专题：非常欢迎你在这里发布自己的新作品，我们大家都非常乐意去尝试你的新作。需要注意的是，发布作品请在 <a href="http://simcity.pro/go/4" target="_blank">分享创造</a> 节点，而非其他节点。<div class="sep10"></div></li>
